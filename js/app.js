	...
	if(dataItem) {
		for (i = 0; i < dataItem.length; i++) {
			...
			if (dataItem[i].isChecked == true) {
				...
				newItem.innerHTML = '<input type="checkbox" name="complited" onchange="done(this)" checked /><span style="text-decoration: line-through">' 
				+ dataItem[i].description + '</span><a id="' + dataItem[i].itemId 
				+ '" class="btn delete-item" onclick="deleteItem(this)">-</a>';
